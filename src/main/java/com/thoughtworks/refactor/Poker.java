...
public class Poker {
    public String compareResult(String blackPlayerCard, String whitePlayerCard) {
        ...
        int[] blackCardNumbers = convertCardStringToSortedNumbers(blackPlayerCard);
        ...
        if (blackCardTypeIndex < whiteCardTypeIndex) {
            ...
            } else if (blackCardTypeIndex == 4) { //顺子
                if (blackCardNumbers[0] < whiteCardNumbers[0]) {
                    String sig = intNumber(whiteCardNumbers[0]);
                    winResult = "white wins - high card:" + sig;
                } else if (blackCardNumbers[0] > whiteCardNumbers[0]) {
            ...
            } else if (blackCardTypeIndex == 5) { //三条
            ...
            } else if (blackCardTypeIndex == 6) { //两对
                for (int i = 0; i < 2; i++) {
            ...
            } else if (blackCardTypeIndex == 7) { //对子
                if (blackRepeat[0] < whiteRepeat[0]) {
                    String sig = intNumber(whiteRepeat[0]);
                    winResult = "white wins - high card:" + sig;
    ...
    private int[] getSortedCardNumbers(int[] number) {
    ...
    private String getCardType(String str) {
        ...
        int[] number = convertCardStringToSortedNumbers(str);
        int i;
    ...
    //数字转化并将其从大到小排序
    private int[] convertCardStringToSortedNumbers(String str) {
