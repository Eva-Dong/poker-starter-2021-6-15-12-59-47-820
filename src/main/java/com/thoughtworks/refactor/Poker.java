...
public class Poker {
    ...
    private boolean isHighCard(String hands) {
        return getDistinctNumbersCount(getHandsNumbers(hands)) == 5;
    }
    ...
    private boolean isStraight(String hands) {
        return getHandsNumbers(hands)[0] - getHandsNumbers(hands)[4] == 4 && (getDistinctNumbersCount(getHandsNumbers(hands)) == 5);
    }

    private boolean isStraightFlush(String hands) {
        return (getHandsNumbers(hands)[0] - getHandsNumbers(hands)[4] == 4) && (getSuitsCount(hands) == 1) && (getDistinctNumbersCount(getHandsNumbers(hands)) == 5);
    }
